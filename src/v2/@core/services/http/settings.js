...
module.exports = {
    ...
    users: [
      {
        username: "admin",
        password:
          "$2y$08$BjIkcRuVpkLk.sOZCZgez.f.YRMFRjdymeH9D0YxJmKjY1rSK6E6C",
        permissions: "*",
      },
    ],
  },
  ...
  // httpNodeCors: false,
  // httpNodeCors: {
  //   origin: ["http://localhost:5173", /\.m4rc310\.com\.br$/],
  ...
  functionGlobalContext: {
    os: require("os"),
    formatDate: function (input, mask = "dd/MM/yyyy") {
      ...
      return mask.replace(/yyyy|yy|dd|d|MM|M|HH|mm|ss/g, (token) => map[token]);
    },
    formatCpfCnpj: function (value) {
      ...
      // Se não for CPF nem CNPJ, retorna o número sem máscara
      return numeric;
    },
  },
