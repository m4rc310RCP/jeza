...
const MTabContextContext = createContext<IMTabContextValues>(defaultValue);
...
const MTabContextProvider: FC<PropsWithChildren> = ({ children }) => {
  ...
  return (
    <MTabContextContext.Provider value={value}>
      {children}
    </MTabContextContext.Provider>
  );
};

export { MTabContextProvider, MTabContextContext };
